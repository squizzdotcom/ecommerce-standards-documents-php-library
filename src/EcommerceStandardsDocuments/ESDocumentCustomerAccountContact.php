<?php
	...
	*     "configs":{"dataFields":"keyContactID,keyCustomerAccountID,contactCode,title,name1,name2,name3,email,phone1,phone2,phone3,fax,website,orgName,orgPosition,isPrimary,allowMarketing,marketingCategoryCodes,authCode"},
	*     "dataRecords":
	*      [
	*         {
	*             "keyContactID":"CON1",
	*             "keyCustomerAccountID":"1",
	*         },
	*         {
	*             "keyContactID":"2",
	...
	* }
	*/
	class ESDocumentCustomerAccountContact extends ESDocument implements \JsonSerializable
	{
		/**
