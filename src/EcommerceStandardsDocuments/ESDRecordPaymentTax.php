<?php
	...
	*/
	class ESDRecordPaymentTax
	{
		/**
		* @var string Key of the taxcode record that the payment tax record is linked to.
		*/
		public $keyTaxcodeID = "";
		...
		*/
		...
		/**
		* @var double Numeric amount as a percentage rate that the taxcode applies to. Eg. if  to 10, then a 10% tax will be applied on top of the payment price.
		*/
		public $taxRate = 0.0;
