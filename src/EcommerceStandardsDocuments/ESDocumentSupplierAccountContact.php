<?php
	...
	*/
	...
	/**
	* Ecommerce standards document that holds a list of contacts records that are associated to supplier accounts. These are the people who are linked to each supplier account.
	* An example of the Supplier Account Contact Ecommerce Standards document in its JSON serialised form
	* {
	*     "version": 1.5,
	*     "resultStatus": 1,
	...
	*     "configs":{"dataFields":"keyContactID,keySupplierAccountID,contactCode,title,name1,name2,name3,email,phone1,phone2,phone3,fax,website,orgName,orgPosition,isPrimary,allowMarketing,marketingCategoryCodes,authCode"},
	*     "dataRecords":
	*      [
	*         {
	*             "keyContactID":"CON1",
	...
	* }
	*/
	class ESDocumentSupplierAccountContact extends ESDocument implements \JsonSerializable
	{
		/**
