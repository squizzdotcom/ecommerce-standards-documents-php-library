<?php
	...
	*}
	*/
	class ESDocumentCustomerAccountAddress extends ESDocument implements \JsonSerializable
	{
		/**
		* @var ESDRecordCustomerAccountAddress[] List of customer account address records
		*/
		...
		*  @param customerAccountAddressRecords		ESDRecordCustomerAccountAddress[]	list of customer account address records
		*  @param configs 							array								A list of key value pairs that contain additional information about the document.
		*/
		public function __construct($resultStatus = 0, $message = "", $customerAccountAddressRecords = array(), $configs = array())
		{
			$this->resultStatus = $resultStatus;
			$this->message = $message;
			$this->dataRecords = $customerAccountAddressRecords;
			$this->configs = $configs;
			if ($customerAccountAddressRecords != null)
			{
				$this->totalDataRecords = count($customerAccountAddressRecords);
			}
		}
