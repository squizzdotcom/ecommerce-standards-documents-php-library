<?php
	...
	*/
	class ESDRecordCustomerAccountEnquiryInvoiceLine   
	{
		/**
		* @var string Key that allows the customer account invoice line record to be uniquely identified and linked to.
		*/
		public $keyInvoiceLineID = "";
