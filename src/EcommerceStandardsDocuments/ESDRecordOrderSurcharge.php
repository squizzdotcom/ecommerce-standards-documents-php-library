<?php
	...
	*/
	class ESDRecordOrderSurcharge   
	{
		/**
		* @var ESDRecordOrderLineTax[] List of tax records applied to the surcharge.
		*/
		public $taxes = array();

		/**
		* @var string Key of the surcharge record that the order line surcharge record is linked to.
		*/
