<?php
	...
	* }
	*/
	class ESDocumentCustomerAccountEnquiry extends ESDocument implements \JsonSerializable
	{	
		/**
		* @var ESDRecordCustomerAccountEnquiryInvoice[] list of Customer Account Enquiry Invoice records.
		*/
        public $invoiceRecords = array();
        /**
		* @var ESDRecordCustomerAccountEnquiryOrderSale[] list of Customer Account Enquiry Order Sale records.
		*/
        public $orderSaleRecords = array();
        /**
		* @var ESDRecordCustomerAccountEnquiryBackOrder[] list of Customer Account Enquiry Back Order records.
		*/
        public $backOrderRecords = array();
        /**
		* @var ESDRecordCustomerAccountEnquiryTransaction[] list of Customer Account Enquiry Transaction records.
		*/
        public $transactionRecords = array();
        /**
		* @var ESDRecordCustomerAccountEnquiryPayment[] list of Customer Account Enquiry Payment records.
		*/
        public $paymentRecords = array();
        /**
		* @var ESDRecordCustomerAccountEnquiryCredit[] list of Customer Account Enquiry Credit records.
		*/
        public $creditRecords = array();
        /**
		* @var ESDRecordCustomerAccountEnquiryQuote[] list of Customer Account Enquiry quote records.
		*/
        public $quoteRecords = array();
		...
		*/
		public function jsonSerialize()
		{
			return array_filter([
				...
				'invoiceRecords' => array_filter($this->invoiceRecords),
				'orderSaleRecords' => array_filter($this->orderSaleRecords),
				'backOrderRecords' => array_filter($this->backOrderRecords),
				'transactionRecords' => array_filter($this->transactionRecords),
				'paymentRecords' => array_filter($this->paymentRecords),
				'creditRecords' => array_filter($this->creditRecords),
				'quoteRecords' => array_filter($this->quoteRecords)
