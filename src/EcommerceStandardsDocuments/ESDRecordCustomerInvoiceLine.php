<?php
	...
	*/
	class ESDRecordCustomerInvoiceLine
	{
		/**
		...
		*/
		...
		/**
		* @var string Code of the line in the original purchase order associated to the customer's invoice line
		*/
		public $purchaseOrderLineCode = "";

		/**
		* @var string number of the line in original purchase order associated to the customer's invoice line
		*/
		public $purchaseOrderLineNumber = "";
		
		/**
		* @var string Code of the line in the customer's customer invoice associated to the line
		*/
		public $customerInvoiceLineCode = "";

		/**
		* @var string number of the line in the customer's customer invoice associated to the invoice line
		*/
		public $customerInvoiceLineNumber = "";
		
		/**
		* @var string Code of the line in the customer's sales order associated to the invoice line
		*/
		public $salesOrderLineCode = "";

		/**
		* @var string number of the line in the customer's sales order associated to the invoice line
		*/
		...
		*/
		...
		/**
		* @var string code of the product in the customer's supplier invoice, that stores the code of the customer's product
		*/
		public $supplierInvoiceProductCode = "";
		...
		*/
		...
		/**
		* @deprecated
		* @var string code of the download in the customer's supplier invoice, that stores the code of the customer's download
		*/
		public $supplierInvoiceDownloadCode = "";
		...
		*/
		...
		/**
		* @var string description the asset in the line.
		*/
        public $assetDescription = "";

		/**
		* @var string code of the asset in the customer's supplier invoice, that stores the code of the customer's asset
		*/
        public $supplierInvoiceAssetCode = "";
		...
		*/
		...
		/**
		* @var string code of the labour in the customer's supplier invoice, that stores the code of the customer's labour
		*/
		public $supplierInvoiceLabourCode = "";
		...
		*/
		...
		/**
		* @var string Code of the customer's product/labour/download that the line is associated to
		*/
		public $customerItemCode = "";
		...
		*/
		public function setDefaultValuesForNullMembers()
		{
			...
			{
				$this->supplierInvoiceProductCode = "";
			}
			...
			{
				$this->supplierInvoiceDownloadCode = "";
			}
			...
			{
				$this->supplierInvoiceLabourCode = "";
			}
