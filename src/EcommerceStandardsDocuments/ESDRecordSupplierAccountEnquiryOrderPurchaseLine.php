<?php
	...
	*/
	class ESDRecordSupplierAccountEnquiryOrderPurchaseLine   
	{
		/**
		* @var string Key that allows the supplier account purchase order line record to be uniquely identified and linked to.
		*/
		public $keyOrderPurchaseLineID = "";
		...
		*/
		...
		/**
		* @var string Defines the type of data that the line represents. Set it to one of the constants prefixed with RECORD_LINE_TYPE_ in the ESDocumentConstants class
		*/
		public $lineType = "";
		...
		*/
		...
		/**
		* @var double percentage amount associated with the taxcode that has been used to calculate the line tax.
		*/
