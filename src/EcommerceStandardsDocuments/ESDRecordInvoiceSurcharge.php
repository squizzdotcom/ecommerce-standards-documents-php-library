<?php
	...
	*/
	class ESDRecordInvoiceSurcharge   
	{
		/**
		* @var ESDRecordInvoiceLineTax[] List of tax records applied to the surcharge.
		*/
		public $taxes = array();

		/**
		* @var string Key of the surcharge record that the invoice line surcharge record is linked to.
		*/
