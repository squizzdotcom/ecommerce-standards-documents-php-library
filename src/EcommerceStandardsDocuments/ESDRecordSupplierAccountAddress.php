<?php
	...
	*/
	class ESDRecordSupplierAccountAddress   
	{
		/**
		* @var string Key that allows the supplier account address record to be uniquely identified and linked to.
		*/
		public $keyAddressID = "";

		/**
		* @var string Key of the supplier account record that the address record is linked to.
		*/
		public $keySupplierAccountID = "";

		/**
		* @var string Description of the supplier account address. This may be used as a label to help a person identify with the address.
		*/
		public $description = "";
		...
		*/
		...
		/**
		* @var string Either 'N'-No or 'Y'-Yes If 'Y' then indicates that the address is the primary address assigned to the supplier account. Typically a primary address would be the account's billing address.
		*/
		public $isPrimary = "";

		/**
		* @var string Either 'N'-No or 'Y'-Yes If 'Y' then indicates that the address may be used by the supplier account where it delivers goods from.
		*/
		public $isDelivery = "";
