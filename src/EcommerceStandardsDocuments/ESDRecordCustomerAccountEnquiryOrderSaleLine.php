<?php
	...
	*/
	class ESDRecordCustomerAccountEnquiryOrderSaleLine   
	{
		/**
		* @var string Key that allows the customer account sales order line record to be uniquely identified and linked to.
		*/
		public $keyOrderSaleLineID = "";
		/**
